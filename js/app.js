...
(function patchFunFacts(){
  const ff={
    ...
    'chinese-giant-salamander':'The Chinese giant salamander can reach 1.8 meters — the largest living amphibian — and has remained essentially unchanged for 170 million years. It detects prey through vibrations in the water and breathes almost entirely through its wrinkled skin.',
    ...
    'common-earthworm':'A single acre of healthy soil contains up to 1 million earthworms that process 10-18 tonnes of soil per year. Darwin spent 39 years studying them and concluded they are "the most important creatures in the history of the world." They possess five pairs of aortic arches that function as hearts, pumping blood through a closed circulatory system.',
    ...
    'medicinal-leech':'Medicinal leeches inject a cocktail of 100+ bioactive compounds including hirudin, the most potent natural anticoagulant known. They are FDA-approved medical devices, used in modern microsurgery to relieve venous congestion after reattachment procedures.',
    ...
    'sequoia':'General Sherman, a giant sequoia, is the largest living organism by volume at 1,487 cubic meters — it adds enough wood each year to build a five-bedroom house and has been growing for approximately 2,200 years.',
    ...
    'titan-arum':'Rafflesia arnoldii, the corpse flower, produces the largest individual flower on Earth at up to 1 meter across and 11 kg — it has no roots, stems, or leaves and lives entirely as a parasite inside tropical vines.',
