...
const PHOTO_MAP = {
  ...
  'platyhelminthes':       {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Schmidtea_mediterranea.jpg/320px-Schmidtea_mediterranea.jpg', credit:'Alejandro Sánchez Alvarado, CC BY 2.5'},
  'planarian':             {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Schmidtea_mediterranea.jpg/320px-Schmidtea_mediterranea.jpg', credit:'Alejandro Sánchez Alvarado, CC BY 2.5'},
  'tardigrada':            {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/Ramazzottius_varieornatus.jpg/320px-Ramazzottius_varieornatus.jpg', credit:'Tanaka S et al., CC BY 4.0'},
  ...
  'sarcopterygii':         {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Coelacanth_cast.jpg/320px-Coelacanth_cast.jpg', credit:'OpenCage, CC BY-SA 2.5'},
  ...
  'red-kangaroo':          {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Macropus_rufus_-_Red_Kangaroo%2C_Broken_Hill%2C_New_South_Wales.jpg/320px-Macropus_rufus_-_Red_Kangaroo%2C_Broken_Hill%2C_New_South_Wales.jpg', credit:'Rhett Wyman, CC BY-SA 4.0'},
  ...
  'hippopotamus':          {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Hippo_pod_edit.jpg/320px-Hippo_pod_edit.jpg', credit:'David Brossard, CC BY-SA 2.0'},
  'wolverine':             {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Wolverine_on_rock.jpg/320px-Wolverine_on_rock.jpg', credit:'Zefram, CC BY-SA 3.0'},
  ...
  'narwhal':               {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Narwhalsk.jpg/320px-Narwhalsk.jpg', credit:'Glenn Williams, Public Domain'},
  ...
  'flamingo':              {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Flamingos_Tiergarten_Sch%C3%B6nbrunn_2010.jpg/320px-Flamingos_Tiergarten_Sch%C3%B6nbrunn_2010.jpg', credit:'Alois Staudacher, CC BY-SA 2.0'},
  'barn-owl':              {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/Tyto_alba_close_up.jpg/320px-Tyto_alba_close_up.jpg', credit:'Peter Trimming, CC BY 2.0'},
  'cassowary':             {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Southern_Cassowary_7071.jpg/320px-Southern_Cassowary_7071.jpg', credit:'Bjørn Christian Tørrissen, CC BY-SA 3.0'},
  'electric-eel':          {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/Electric-eel.jpg/320px-Electric-eel.jpg', credit:'Steven G. Johnson, CC BY-SA 3.0'},
  'poison-dart-frog':      {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Oophaga_pumilio_%28Strawberry_poison-dart_frog%29.jpg/320px-Oophaga_pumilio_%28Strawberry_poison-dart_frog%29.jpg', credit:'Pstevendactylus, CC BY-SA 3.0'},
  'firefly':               {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Photinus_pyralis_Firefly.jpg/320px-Photinus_pyralis_Firefly.jpg', credit:'Art Farmer, CC BY-SA 2.0'},
  'atlas-moth':            {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Attacus_atlas_qtl1.jpg/320px-Attacus_atlas_qtl1.jpg', credit:'Quartl, CC BY-SA 3.0'},
  'army-ant':              {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Eciton_burchellii_army_ants.jpg/320px-Eciton_burchellii_army_ants.jpg', credit:'Geoff Gallice, CC BY 2.0'},
  'japanese-spider-crab':  {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Japanese_spider_crab.jpg/320px-Japanese_spider_crab.jpg', credit:'Michael Wolf, CC BY-SA 3.0'},
  'garden-spider':         {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Argiope_aurantia.jpg/320px-Argiope_aurantia.jpg', credit:'Luc Viatour, CC BY-SA 3.0'},
  'hermit-crab':           {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Hermit_crab_at_Bandon_Beach.jpg/320px-Hermit_crab_at_Bandon_Beach.jpg', credit:'Bureau of Land Management, CC BY 2.0'},
  'portuguese-man-o-war':  {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Portuguese_Man-O-War_%28Physalia_physalis%29.jpg/320px-Portuguese_Man-O-War_%28Physalia_physalis%29.jpg', credit:'Volkan Yuksel, CC BY-SA 3.0'},
  'hammerhead-shark':      {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Hammerhead_shark%2C_Cocos_Island%2C_Costa_Rica.jpg/320px-Hammerhead_shark%2C_Cocos_Island%2C_Costa_Rica.jpg', credit:'Barry Peters, CC BY 2.0'},
  'water-lily':            {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Nymphaea_alba.jpg/320px-Nymphaea_alba.jpg', credit:'Abrahami, CC BY-SA 3.0'},
  'bamboo':                {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Bamboo_forest.jpg/320px-Bamboo_forest.jpg', credit:'Chris 73, CC BY-SA 3.0'},
  'cactus':                {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Echinopsis_chiloensis_ssp._chiloensis_%28Coquimbo%2C_Chile%29.jpg/320px-Echinopsis_chiloensis_ssp._chiloensis_%28Coquimbo%2C_Chile%29.jpg', credit:'Daderot, CC0 1.0'},
  'sundew':                {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/Drosera_capensis_bend.JPG/320px-Drosera_capensis_bend.JPG', credit:'Noah Elhardt, CC BY 2.5'},
  'truffle':               {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Truffe_noire_du_P%C3%A9rigord.jpg/320px-Truffe_noire_du_P%C3%A9rigord.jpg', credit:'Keriluamox, CC BY-SA 4.0'},
  'chanterelle':           {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Chanterelle_Mushrooms.jpg/320px-Chanterelle_Mushrooms.jpg', credit:'Strobilomyces, CC BY-SA 3.0'},
  'lichen':                {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/Flavoparmelia_caperata_-_lichen_-_Cladonia.jpg/320px-Flavoparmelia_caperata_-_lichen_-_Cladonia.jpg', credit:'Jason Hollinger, CC BY 2.0'},
  'euglena':               {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Euglena_viridis.jpg/320px-Euglena_viridis.jpg', credit:'Claudio Miklos, CC BY 2.5'},
  'radiolarian':           {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Haeckel_Phaeodaria.jpg/320px-Haeckel_Phaeodaria.jpg', credit:'Ernst Haeckel, Public Domain'},
  'stentor':               {url:'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Stentor_coeruleus.jpg/320px-Stentor_coeruleus.jpg', credit:'Picturepest, CC BY 2.0'},
};
